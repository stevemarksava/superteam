...
- **Squad upgrade loop:** After every push, run `node C:/dev/superteam/mcp-servers/superteam-brain/scripts/upgrade-squad.mjs`. Superman runs this automatically. Steve never has to ask. It is step 6 of the delivery workflow.
